            ...
            <div className="mt-12 flex flex-col items-center">
              ...
              <div className="w-full flex-1 mt-8">
                ...
                <div className="mx-auto max-w-xs">
                  ...
                  <button className="mt-5 tracking-wide font-semibold bg-purple-400 text-gray-100 w-full py-4 rounded-lg hover:bg-purple-500 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
                    <svg
                  ...
                  <div className="mt-8">
                    <p className="text-xs text-center">
                      ...
                      <Link href={"/signup"} className="text-sm text-purple-400">
                        Sign up
                      </Link>
                    </p>
                  </div>
